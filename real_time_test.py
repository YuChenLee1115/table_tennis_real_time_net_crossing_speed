...
class PingPongSpeedTracker:
    ...
    def generate_outputs(self):
        ...
        # 會話標識
        session_id = f"session_{self.count_session}_{timestamp}"
        ...
        plt.grid(True)
        chart_filename = f'{OUTPUT_FOLDER}/speed_chart_{session_id}.png'
        plt.savefig(chart_filename)
        plt.close()
        
        # 將速度數據保存到TXT檔案
        txt_filename = f'{OUTPUT_FOLDER}/speed_data_{session_id}.txt'
        ...
        # 將速度數據保存到CSV檔案
        csv_filename = f'{OUTPUT_FOLDER}/speed_data_{session_id}.csv'
